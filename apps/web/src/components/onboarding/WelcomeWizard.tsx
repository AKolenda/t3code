      ...
      <div className="flex h-full min-h-40 flex-col">
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-3 py-6">
          ...
          <p className="text-center text-sm text-muted-foreground">
            Looking for projects from Claude Code, Codex, Cursor, and OpenCode…
          </p>
        </div>
...
function ImportRowMeta({
  ...
  return (
    <span className="ml-auto grid shrink-0 grid-cols-[repeat(4,1rem)_2.5rem_2.25rem] items-center gap-x-1 text-xs text-muted-foreground tabular-nums">
      ...
      <span className="flex size-4 items-center justify-center">
        {sources?.includes("cursor") ? <CursorIcon className="size-3" aria-label="Cursor" /> : null}
      </span>
      <span className="flex size-4 items-center justify-center">
        {sources?.includes("opencode") ? (
          <OpenCodeIcon className="size-3" aria-label="OpenCode" />
        ) : null}
      </span>
