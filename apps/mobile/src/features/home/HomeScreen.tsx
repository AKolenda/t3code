...
// Rows away from the viewport stay mounted as cheap dormant frames (see
// swipe-row-activation), so keep about 140 of them: scrolling back and forth
// then never has to rebuild a row.
const THREAD_LIST_V2_DRAW_DISTANCE = 10_000;
